...
<body>
	<div class="header">
		...
		<div class="center position"><b>车辆信息</b></div>
		...
		<c:forEach var="car"  items="${cars}">
			<div class="weui-form-preview">
	            <div class="weui-form-preview__hd">
	                <a href="../servlet/otherweb?requestpage=liquid/CarEdit&openid=${openid}&carid=${car['ID']}" >
	                <div class="weui-form-preview__item">
	                    <label class="weui-form-preview__label">车牌号</label>
	                    <em class="weui-form-preview__value">${car['CarNo']}</em>
	                </div>
	                 </a>
	            </div>
    ...
    <div class="foot" style="background-color: #F2F2F2;z-index: 100;"> 
            <div class="weui-btn-area" style="float:left;margin-top:8px;">
   				<a href="../servlet/otherweb?requestpage=liquid/CarAdd&openid=${openid}" class="weui-btn weui-btn_primary" id="btn" style="background-color: #fff;font-size:0.8em;color:#000000;border:1px solid rgba(0,0,0,.2)">添加</a>
  			</div>
