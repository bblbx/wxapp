...
<body>
	<div class="header">
		...
		<div class="center position"><b>司机信息</b></div>
		...
		<c:forEach var="driver"  items="${drivers}">
			<div class="weui-form-preview">
	            <div class="weui-form-preview__hd">
	                <a href="../servlet/otherweb?requestpage=liquid/DriverEdit&openid=${openid}&callliquidid=${driver['ID']}" >
	                <div class="weui-form-preview__item">
	                    <label class="weui-form-preview__label">姓名</label>
	                    <em class="weui-form-preview__value">${driver['Name']}</em>
	                </div>
	                 </a>
	            </div>
	            <div class="weui-form-preview__bd">
	             	...
	             	<div class="weui-form-preview__item">
	                    ...
	                    <span class="weui-form-preview__value">${driver['Tel']}</span>
	                </div>
	                 <div class="weui-form-preview__item">
	                    <label class="weui-form-preview__label">创建时间:</label>
	                    <span class="weui-form-preview__value">${driver['CreateTime']}</span>
	                </div>
    ...
    <div class="foot" style="background-color: #F2F2F2;z-index: 100;"> 
            <div class="weui-btn-area" style="float:left;margin-top:8px;">
   				<a href="../servlet/otherweb?requestpage=liquid/DriverAdd&openid=${openid}" class="weui-btn weui-btn_primary" id="btn" style="background-color: #fff;font-size:0.8em;color:#000000;border:1px solid rgba(0,0,0,.2)">添加</a>
  			</div>
